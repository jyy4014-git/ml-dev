...
#         a_channel = 'channel1'
#         mystork_data = redis_self.sub_msg(a_channel)
#         while True:
        stock = redis_self.sub_msg('channel1')
        stock2 = redis_self.sub_msg('stock_info')
        print(stock2)
        print(stock)

        real_profitloss = stock2['수익률']
        real_num_stock = stock2['체결잔고수량']
        real_avg_buy_price = stock2['체결장부단가']
        print(stock2)
        ...
        self.num_stocks = real_num_stock  # 보유 주식 수
        ...
        self.profitloss = real_profitloss  # 손익률
        self.avg_buy_price = real_avg_buy_price  # 주당 매수 단가
